...
SLAP_TEMPLATES = [
    "@Estrlaa {hits} {victim} dengan sebuah {item}.",
    "@Estrlaa {hits} {victim} tepat diwajahnya menggunakan {item}.",
    "@Estrlaa {hits} {victim} dengan sebuah {item} hingga pingsan.",
    "@Estrlaa {throws} sebuah {item} ke {victim}.",
    "@Estrlaa mengambil {item} kemudian {throws} itu ke {victim} karena kesal.",
    "@Estrlaa melempar {item} ke wajah {victim} dengan sangat keras.",
    "@Estrlaa memukul {victim} hingga pingsan menggunakan sebuah {item}.",
    "@Estrlaa memasung {victim} lalu {hits} dia menggunakan sebuah {item}.",
    "@Estrlaa mengambil {item} dan {hits} {victim} menggunakan itu.",
    "@Estrlaa mengikat {victim} ke kursi lalu {throws} sebuah {item} dengan sangat keras.",
    "@Estrlaa mengubur hidup-hidup {victim} di belakang rumahnya."
]
