...
USER_BOT_NO_WARN = ("`Hello My Friend! This is` **KERABAT USERBOT**\n"
                    "`Private Messaging Security Protocol ⚠️`\n\n"
                    "**Currently My Boss**\n"
                    f"{DEFAULTUSER} is Busy ! Please Don't Spam My Boss Inbox\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(891467722)))
