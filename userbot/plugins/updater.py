...
OFFICIAL_UPSTREAM_REPO = "https://github.com/KerabatOnline/FridayUserbot"
BOT_IS_UP_TO_DATE = "Kerabat userbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**Kerabat Userbot Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
